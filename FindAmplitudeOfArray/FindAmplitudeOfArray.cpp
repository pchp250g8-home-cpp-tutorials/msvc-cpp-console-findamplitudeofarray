// FindAmplitudeOfArray.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
#include <iostream>
#include <valarray>
#include <stdlib.h>
...
int main(int argc, char* argv[])
{
    ...
    std::cout << "Found minimum element: " << iMin << " with index " << nMinIndex << "\r\n";
