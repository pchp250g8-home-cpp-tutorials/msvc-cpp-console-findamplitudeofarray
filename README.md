...
The program does the following:
   ...
   5. Variables are introduced for the index of the maximum and minimum array elements and their values.
      The element indices are equal to 0, and the values ​​are equal to the value of the first (zeroth) element of the array.
   6. The second loop with the parameter is executed:
   ...
   7. After the loop completes, the index and value variables of the element will contain the maximum and minimum of the array.
   8. The maximum and minimum elements of the array and the range of the series are displayed on the screen.
